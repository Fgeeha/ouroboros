...
BAND_PATHS = {
    ...
    "launcher.py": "Grant validation and effects now use the shared lifecycle owner; the launcher retains native confirmation and server reconcile transport.",
    ...
    "ouroboros/tools/registry_guards.py": "Ordinary skill development no longer owns a reduced Repair profile; shared resource guards preserve target and child authority.",
