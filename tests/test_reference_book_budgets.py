...
CHAPTER_BYTE_BUDGETS: dict[str, int] = {
    ...
    # 11400 -> 12300: presence PR0 adds rules the chapter lacked, one sentence each (unified
    # conversation key, placeholder re-run, presence-local liveness, previous-turn pointer,
    # split in-flight budgets, silent orphaned work, presence room label); the base sat 2 bytes under.
    "docs/architecture/12-host-service-companions-and-chat-ids.md": 12300,
